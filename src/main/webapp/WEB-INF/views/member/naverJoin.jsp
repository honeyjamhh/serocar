...
<body>
	<form action="./naverRegisterCustomer" class="form" method="POST">
		<div class="center">
			<div class="container">
				<div class="text">회원가입</div>
				<div class="small-text">SEROCAR SIGN UP</div>

				<class class="uk-form-stacked">
					<div>
						<label class="label-text" for="memberEmailTxt" id="memberEmailTxt">이메일</label>
						<div class="uk-form-controls input-button-flex">
							<input class="uk-input" type="text" id="memberEmail" required="required"
								name="memberEmail" placeholder="" value="${memberEmail }" readonly="readonly"/>
				...
				<div>
					...
					<div class="uk-form-controls">
						<input class="uk-input" type="text" id="memberNickname" required="required"
							name="memberNickname" placeholder="" value="${memberNickname }"/>
					</div>
				</div>
				<div>
