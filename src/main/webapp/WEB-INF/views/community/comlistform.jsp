                        ...
                        <div class="drop_menu mouse_click">
                           ...
                           <div class="paging-in" style="text-align: center;">
                                 ...
                                 <img src="/resources/images/community/prev.png">&nbsp;
                                    ...
                                    <c:otherwise>
                                       <a href="communityList?keyword=${searchKeyword }&page=${pageInfo.page-1}"><img src="/resources/images/community/prev.png"></a>&nbsp;
                              </c:otherwise>
                                 </c:choose>
                              <c:forEach var="i" begin="${pageInfo.startPage }"
                                 ...
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <a href="communityList?keyword=${searchKeyword }&page=${i}">[${i }]</a>
                                    </c:otherwise>
                                 </c:choose> 
                              </c:forEach>
                                 ...
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <a href="communityList?keyword=${searchKeyword }&page=${pageInfo.page+1}">&nbsp;<img src="/resources/images/community/next.png"></a>
                                    </c:otherwise>
                                 </c:choose>
                              </div>
                        <div class="btn_area">
