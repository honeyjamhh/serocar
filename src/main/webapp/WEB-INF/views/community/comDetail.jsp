                           ...
                           <div class="detailTitle">
                              <div class="boardList">
                                 ...
                                 <c:if test="${ memberEmail != null && memberEmail == article.memberEmail }">
                                       <a href="/modifyform?comNum=${article.comNum }">수정</a>
                                       <a href="/delete?comNum=${article.comNum }">삭제</a>
                                    </c:if>
                              </div>
                              ...
                              <div class="userInfo">
                                 ...
                                 <div class="userNickname">
                                    ...
                                    <div class="create">
                                       <span class="date">${article.comDate }</span> <span class="count">${comViews }</span>
