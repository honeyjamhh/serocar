      ...
      <div class="wrapper">
         ...
         <div id="reviewEditModal" class="review-edit-modal">
            <div class="review-edit-modal-body">
               <div class="review-edit-modal-close-btn"
                  onclick="hideReviewEditModal()">&times;</div>
               <div
               ...
               <div
                  style="display: flex; justify-content: flex-start; align-items: center; flex-direction: column; margin: 16px 0">
                  <textarea class="review-edit-textarea" rows="5" maxlength="200"
                     id="reviewModal"></textarea>
               </div>
               <div
                  style="display: flex; justify-content: flex-start; align-items: center; flex-direction: column">
                  <button class="uk-button info-list-review-complete-button"
                     id="updateReviewInMyPage">수정완료</button>
               </div>
            </div>
         </div>
